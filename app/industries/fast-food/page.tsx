...
export default function FastFoodPage() {
  return (
    <>
      ...
      <HowToSchema name="How MartPoint Works for Fast Food Outlets" description="Step-by-step workflow using MartPoint Retail." steps={workflow.map((w) => ({ name: w.step, text: w.desc }))} />
      </main>
      <Footer />
    </>
  )

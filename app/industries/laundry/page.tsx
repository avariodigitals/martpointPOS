...
export default function LaundryPage() {
  return (
    <>
      ...
      <HowToSchema name="How MartPoint Works for Laundry & Dry Cleaning" description="Step-by-step workflow using MartPoint Retail." steps={workflow.map((w) => ({ name: w.step, text: w.desc }))} />
      </main>
      <Footer />
    </>
  )

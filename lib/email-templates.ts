...
MartPoint Partner Team`,
  },
  {
    ...
    description: "Sent when an admin invites a partner lead to complete the application form.",
    variables: ["contactName", "inviteLink"],
    subject: "You're invited to apply for the MartPoint Partner Program",
    text: `Hi {{contactName}},

MartPoint would like to invite you to apply for our Partner Program.

Complete your application using the link below — some of your details have been pre-filled for you:
